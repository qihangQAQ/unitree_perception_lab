"""RSL-RL configuration for the Unitree G1 structured depth task."""
...
@configclass
class RslRlDepthProActorCriticCfg(RslRlPpoActorCriticCfg):
    class_name: str = "DepthProActorCritic"
...
@configclass
class RslRlDepthProAlgorithmCfg(RslRlPpoAlgorithmCfg):
    class_name: str = "DepthProPPO"
...
class UnitreeDepthRunnerCfg(RslRlOnPolicyRunnerCfg):
    class_name: str = "unitree_rl_lab.tasks.locomotion.agents.depth_pro.runner:DepthProRunner"
    seed = 42
    ...
    algorithm = RslRlDepthProAlgorithmCfg(
        value_loss_coef=1.0,
